...
$(function(){
	...
	$("#btn-delete-word").click(function(){
		Dialog.confirm({
			...
			onConfirm: function(handle){
				Action.post(
					"/words/adj/action/delete", 
					{id: DataMgr.id}, 
					{
						success: function(){
							location.href = "/words/adj"
						},
						complete: function(){
							handle.close()
						}
	...
	$(".btn-delete-value").click(function(){
		var id = $(this).data("id")
		Action.post("/words/adj/action/delete-value", {id: id}, function(){
			location.reload()
		})
	})
	...
	$("#editable-meanings").editable({
		...
		active: function(val){
			...
			Action.post("/words/adj/action/update-meanings", {id: DataMgr.id, meanings: meanings}, function(){
				location.reload()
			})
		}
	})
	...
	$("#btn-add-value").click(function(){
		...
		Action.post("/words/adj/action/add-value", {id: DataMgr.id, value: value}, function(){
			location.reload()
		})
	})
	...
	$("#btn-add-fixword").click(function(){
		...
		Action.post("/words/adj/action/add-fixword", {id: DataMgr.id, value: word, meaning: meaning}, function(){
			location.reload()
		})
	})
	...
	$(".btn-delete-fixword").click(function(){
		...
		Action.post("/words/adj/action/delete-fixword", {id: DataMgr.id, value: word}, function(){
			location.reload()
		})
	})
	...
	$(".editable-fixword-meaning").editable({
		active: function(val){
			...
			Action.post("/words/adj/action/update-fixword", {id: DataMgr.id, value: word, meaning: val}, function(){
				location.reload()
			})
		}
	})
